...
echo "print the built debains"
ls -lrth /root/kvmfornfv/
ls -lrth /tmp/kvmfornfv/
mv /tmp/kvmfornfv/* /root/kvmfornfv/build_output
mv /root/kvmfornfv/* /root/kvmfornfv/build_output
#cleaning the /tmp
rm -rf ${SRC}
