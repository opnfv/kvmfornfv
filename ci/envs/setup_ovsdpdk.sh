...
function setup_ovsdpdk() {
 ...
 sudo ls -ltr /var/run/openvswitch
 ...
 sudo ./ovsdb-tool create /etc/openvswitch/conf.db $VSPERF/src/ovs/ovs/vswitchd/vswitch.ovsschema
 if [ ${?} -ne 0 ] ; then
 ...
 sudo ./ovs-vsctl add-port ovsbr0 vhost-user4 -- set Interface vhost-user4 type=dpdkvhostuse
}
install_ovsdpdk
setup_ovsdpdk
