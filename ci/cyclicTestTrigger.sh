...
testType=$3
testName=$4
WORKSPACE=/home/jenkins/opnfv/slave_root/workspace/kvmfornfv-verify-test-master
...
function runPacketForwarding {
   testType=$1
   ssh -t root@$HOST_IP "cd /root/workspace/scripts ; sudo scl enable python33 'sh packet_forwarding.sh $testType $QEMURPM_VERSION'"
}
