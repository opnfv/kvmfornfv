...
/usr/libexec/qemu-kvm -drive file=/root/minimal-centos1.qcow2 -nographic -netdev  user,id=net0,hostfwd=tcp:10.2.117.23:5555-:22 -device virtio-net-pci,netdev=net0 &
