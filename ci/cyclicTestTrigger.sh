...
function runCyclicTest {
   ...
   if [ -z "$container_id" ]; then
      ...
      container_id1=`sudo docker ps -a | grep kvmfornfv_${testType} |awk '{print \$1}'|sed -e 's/\r//g'`
      echo "Container Id is :$container_id1"
      echo "Cyclictestoutput is :$cyclictest_output
