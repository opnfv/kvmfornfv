...
${qemu} -smp ${guest_cpus} -drive file=/root/guest1.qcow2 -daemonize -netdev user,id=net0,hostfwd=tcp:10.2.117.23:5555-:22 -device e1000,netdev=net0 -realtime mlock=on -mem-prealloc -enable-kvm -m 1G -mem-path /mnt/hugetlbfs-1g
